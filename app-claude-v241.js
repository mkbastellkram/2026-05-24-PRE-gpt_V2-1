...
const HIKING_VECTOR_CACHE_KEY = 'prHikingVectorGeojsonV241';
const HIKING_VECTOR_META_KEY = 'prHikingVectorMetaV241';
...
function hikingVectorQuery(){
  ...
  // Robust: erst Routenrelationen laden, danach deren Way-Mitglieder mit echter Geometrie.
  // Manche Overpass-Instanzen liefern bei `out tags geom` für Relationen keine Member-Geometrie.
