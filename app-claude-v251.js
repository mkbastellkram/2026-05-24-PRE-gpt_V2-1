/* ============================================================
   ...
   V2.5.1: POI-Fix, Home-Pin, persistente Testnotizen
   ============================================================ */
'use strict';
...
function drawHomePin(){
  ...
  L.marker([h.lat,h.lon],{icon:ico,keyboard:false}).bindPopup(`<b>🏨 ${htmlEsc(h.label||'Home')}</b><br>${h.lat.toFixed(6)}, ${h.lon.toFixed(6)}`).addTo(lgHome);
}
